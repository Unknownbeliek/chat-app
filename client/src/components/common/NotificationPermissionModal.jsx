  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-md animate-in fade-in duration-200 p-4">
      <div className="glass-card p-6 sm:p-8 rounded-3xl max-w-sm w-full text-center flex flex-col items-center shadow-2xl border border-white/10 relative overflow-hidden">
        ...
        {/* Icon Container */}
        <div className="w-16 h-16 rounded-2xl bg-indigo-600/20 border border-indigo-500/30 flex items-center justify-center text-indigo-400 mb-4 shadow-inner relative">
        ...
        <div className="flex flex-col gap-2.5 w-full">
          <button
            onClick={onEnable}
            className="w-full py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white text-xs font-bold shadow-lg shadow-indigo-500/25 transition-all active:scale-95"
          >
            Enable Notifications
          </button>
          <button
            onClick={onSkip}
            className="w-full py-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-zinc-400 hover:text-zinc-200 text-xs font-medium border border-white/10 transition-all active:scale-95"
          >
            Not Now
          </button>
        </div>
