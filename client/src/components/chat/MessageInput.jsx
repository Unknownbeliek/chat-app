    ...
    >
      ...
      <div className="flex-1 relative flex items-center">
        ...
        <button
          ...
          className="absolute left-3 text-lg text-zinc-400 hover:text-amber-400 hover:scale-110 active:scale-95 transition-all z-10"
          title="Choose Emoji"
        >
          😊
        </button>
        ...
        <input
          ...
          className="w-full glass-input pl-10 pr-16 py-3 rounded-2xl text-sm text-zinc-100 placeholder-zinc-400 focus:outline-none focus:border-indigo-500/50 transition-all shadow-inner"
        />
